...
> `PRD-NNN §14` / `DESIGN-NNN §<followups>` sections per PRD-004 D-7. See
...
|---|---|---|---|---|---|
| BL-0001-pm-haiku-tier-intent | `@pm` haiku-tier intent classifier | killed | PRD-001 §14.1 | 2026-05-06 | 2026-05-06 |
| BL-0002-reducing-entropy-skill-b2 | `reducing-entropy` skill | killed | PRD-001 §14.2 | 2026-05-06 | 2026-05-06 |
| BL-0003-post-deploy-analytics-skill-b2 | `post-deploy-analytics` skill | killed | PRD-001 §14.2 | 2026-05-06 | 2026-05-06 |
| BL-0004-save-load-skill | `save` / `load` skill | killed | PRD-001 §14.2 | 2026-05-06 | 2026-05-06 |
| BL-0005-cost-profiler-hook-b3 | `cost-profiler` hook | killed | PRD-001 §14.3 | 2026-05-06 | 2026-05-06 |
| BL-0006-mid-flight-checkpoint-over | Mid-flight checkpoint over end-to-end run | killed | PRD-001 §14.6 | 2026-05-06 | 2026-05-06 |
| BL-0007-heartbeat-stall-detection-b7 | Heartbeat / stall-detection | killed | PRD-002 §8 | 2026-05-06 | 2026-05-06 |
| BL-0008-external-sinks-slack | External sinks (Slack / CI / web dashboard) | killed | PRD-002 §8 | 2026-05-06 | 2026-05-06 |
| BL-0009-install-sh-install | `install.sh` / `install.ps1` | killed | PRD-001 §14.8 | 2026-05-06 | 2026-05-06 |
| BL-0010-consumer-facing-hooks-md | Consumer-facing `HOOKS.md` | killed | PRD-001 §14.8 | 2026-05-06 | 2026-05-06 |
| BL-0011-adr-tools-log4brains-interop | `adr-tools` / `log4brains` interop | killed | DESIGN-005 §14 F-6 | 2026-05-06 | 2026-05-06 |
...
| BL-0013-architect-ux-security | `@architect`, `@ux`, `@security`, `@debugger` specialist agents | deferred | PRD-001 §14.1 | 2026-05-06 | 2026-05-06 |
...
| BL-0015-migration-extraction-skill-orchestra | `migration-extraction` skill + `/orchestra legacy <path>` (B2 / B5) | deferred | PRD-001 §14.2, §14.5 | 2026-05-06 | 2026-05-06 |
| BL-0016-frontend-component-patterns-skill-b2 | `frontend-component-patterns` skill | deferred | DESIGN-006 §8 | 2026-05-06 | 2026-05-06 |
| BL-0017-sc-spec-panel-skill-b2 | `sc-spec-panel` skill | deferred | PRD-001 §14.2, §9.4 | 2026-05-06 | 2026-05-06 |
| BL-0018-n-5-dimension-confidence-scorecard | 5-dimension confidence scorecard | deferred | PRD-001 §14.6 | 2026-05-06 | 2026-05-06 |
| BL-0019-wave-orchestration-pattern | Wave orchestration / Pattern C integration checkpoints | deferred | PRD-001 §14.6 | 2026-05-06 | 2026-05-06 |
| BL-0020-async-option-synthesis | Async `OPTION_SYNTHESIS` / `PROPOSAL-<id>.md` | deferred | PRD-001 line ~539 | 2026-05-06 | 2026-05-06 |
| BL-0021-async-pause-phase | Async `PAUSE-<phase>-<id>.md` artifacts | deferred | WORKFLOW-002 line ~227 | 2026-05-06 | 2026-05-06 |
| BL-0022-sprint-level-rollup-across | Sprint-level rollup across multiple issues | deferred | PRD-002 §8 | 2026-05-06 | 2026-05-06 |
| BL-0023-empirical-ablation-loop | Empirical ablation loop | deferred | PRD-001 §14.7 | 2026-05-06 | 2026-05-06 |
| BL-0024-playwright-mcp-fe | Playwright MCP for FE behavioral probes | deferred | PRD-001 §14.7 | 2026-05-06 | 2026-05-06 |
| BL-0025-parallel-worktrees-pattern | Parallel worktrees pattern | deferred | PRD-001 §14.7 | 2026-05-06 | 2026-05-06 |
| BL-0026-tiered-memory-memory | Tiered memory + memory consolidation | deferred | PRD-001 §14.7 | 2026-05-06 | 2026-05-06 |
| BL-0027-nosql-probes-mongo | NoSQL probes (Mongo / DynamoDB / Redis) | deferred | PRD-001 line ~860 | 2026-05-06 | 2026-05-06 |
...
**Status:** killed · **Source:** PRD-001 §14.1 · **Created:** 2026-05-06
...
**Status:** killed · **Source:** PRD-001 §14.2 · **Created:** 2026-05-06
...
**Status:** killed · **Source:** PRD-001 §14.3 · **Created:** 2026-05-06
...
**Status:** killed · **Source:** PRD-001 §14.6 · **Created:** 2026-05-06
...
**Status:** killed · **Source:** PRD-002 §8 · **Created:** 2026-05-06
...
Explicitly out-of-scope per PRD-002 §Q3. Re-confirm kill.

---

## BL-0009-install-sh-install — `install.sh` / `install.ps1` <a id="BL-0009-install-sh-install"></a>

**Status:** killed · **Source:** PRD-001 §14.8 · **Created:** 2026-05-06
...
**Status:** killed · **Source:** DESIGN-005 §14 F-6 · **Created:** 2026-05-06
...
**Status:** deferred · **Source:** PRD-001 §14.2, §14.5 · **Created:** 2026-05-06
...
**Status:** deferred · **Source:** DESIGN-006 §8 · **Created:** 2026-05-06
...
**Status:** deferred · **Source:** PRD-001 §14.2, §9.4 · **Created:** 2026-05-06
...
**Status:** deferred · **Source:** PRD-001 §14.6 · **Created:** 2026-05-06
...
**Status:** deferred · **Source:** PRD-001 line ~539 · **Created:** 2026-05-06
...
**Status:** deferred · **Source:** WORKFLOW-002 line ~227 · **Created:** 2026-05-06
...
**Status:** deferred · **Source:** PRD-002 §8 · **Created:** 2026-05-06
...
**Status:** deferred · **Source:** PRD-001 §14.7 · **Created:** 2026-05-06
...
**Status:** deferred · **Source:** PRD-001 line ~860 · **Created:** 2026-05-06
