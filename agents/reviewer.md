...
3. Score per-discipline rubrics; classify findings Critical / Major / Minor / Nit. Run structural sweeps (allowed-set, diagram-allowlist, contract presence, untraced-AC, untraced-term, tech-leakage, unworthy-ADR).
