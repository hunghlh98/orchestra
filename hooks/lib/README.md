...
| `bootstrap-consumer-claude-md.js` | Writes orchestra rules to `<context_path>/.orchestra/claude-md/orchestra.md` and adds a `@`-import line to consumer's `<context_path>/CLAUDE.md`. | `mcp__orchestra-utils__claude_md` |
